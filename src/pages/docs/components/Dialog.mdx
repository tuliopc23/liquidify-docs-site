        ...
        <Dialog.Positioner>
          <Dialog.Content>
            ...
            >
              ...
              <div style={{ display: "flex", gap: "1rem", marginTop: "1.5rem" }}>
                <Button type="submit" variant="filled" tone="accent">Save</Button>
                <Dialog.CloseTrigger asChild>
                  <Button variant="tinted" tone="neutral">Cancel</Button>
                </Dialog.CloseTrigger>
              </div>
...
export default function AlertExample() {
  return (
    <Dialog.Root role="alertdialog">
      <Dialog.Trigger asChild>
        <Button variant="filled" tone="destructive">Delete Account</Button>
      </Dialog.Trigger>
      ...
      <Dialog.Positioner>
        <Dialog.Content>
          ...
          <div style={{ display: "flex", gap: "1rem", marginTop: "1.5rem" }}>
            <Dialog.CloseTrigger asChild>
              <Button variant="tinted" tone="neutral">Keep Account</Button>
            </Dialog.CloseTrigger>
            <Button variant="filled" tone="destructive">Yes, Delete Account</Button>
          </div>
        </Dialog.Content>
      </Dialog.Positioner>
    </Dialog.Root>

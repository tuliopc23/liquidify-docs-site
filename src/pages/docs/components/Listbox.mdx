...
import ListboxDemo from "../../../components/demos/ListboxDemo.tsx";

### Basic Usage

<ListboxDemo client:only="react" />
```tsx import {Listbox} from "liquidify-react/ark-ui/listbox"
...
function FormListbox() {
  ...
  return (
    <form onSubmit={handleSubmit((data) => console.log(data))}>
      <Listbox.Root value={selectedValue} onValueChange={(value) => setValue("country", value)}>

          ...
          >
            {[1, 2].map((i) => (
              ...
              >
                ...
                <h5>Product {i}</h5>
                <p>
                  This is a detailed description of the product with more information about its
...
export default function TextFormattingControls() {
  ...
  const sampleText =
    "The quick brown fox jumps over the lazy dog. This is a sample text to demonstrate the formatting controls.";
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <SegmentGroup.Root
          value={alignment}
          onValueChange={(details) => setAlignment(details.value)}
        >
          <SegmentGroup.Item value="left">
            <SegmentGroup.ItemText>⬅️ Left</SegmentGroup.ItemText>
            <SegmentGroup.ItemControl />
          </SegmentGroup.Item>

          <SegmentGroup.Item value="center">
            <SegmentGroup.ItemText>⬌ Center</SegmentGroup.ItemText>
            <SegmentGroup.ItemControl />
          </SegmentGroup.Item>

          <SegmentGroup.Item value="right">
            <SegmentGroup.ItemText>➡️ Right</SegmentGroup.ItemText>
            <SegmentGroup.ItemControl />
          </SegmentGroup.Item>

          <SegmentGroup.Item value="justify">
            <SegmentGroup.ItemText>⬌ Justify</SegmentGroup.ItemText>
            <SegmentGroup.ItemControl />
          </SegmentGroup.Item>
        </SegmentGroup.Root>
      </div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <SegmentGroup.Root value={sortBy} onValueChange={(details) => setSortBy(details.value)}>
          <SegmentGroup.Item value="date">
            <SegmentGroup.ItemText>📅 Date</SegmentGroup.ItemText>
            <SegmentGroup.ItemControl />
          </SegmentGroup.Item>
  ...
  return (
    ...
    >
      ...
      >
        <h4>Preview</h4>
        <p>
          This is how your content will look with the <strong>{currentTheme.name}</strong> theme.
        </p>
...
export default function UnitConverter() {
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "500px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        <label style={{ display: "block", marginBottom: "0.5rem" }}>Enter Value</label>
        <input
          type="number"
          value={inputValue}
      ...
      >
        ...
        {result ? (
          ...
          <div style={{ color: "#666" }}>Enter a value to see the conversion</div>
        )}
      </div>
    </div>
  );
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <SegmentGroup.Root
          value={playbackSpeed}
          onValueChange={(details) => setPlaybackSpeed(details.value)}
        >
          {speeds.map((speed) => (
      ...
      >
        ...
        <p>
          Playback Speed: <strong>{playbackSpeed}</strong>
        </p>
        <p>

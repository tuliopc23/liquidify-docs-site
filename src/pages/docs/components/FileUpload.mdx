  ...
  return (
    <FileUpload.Root maxFiles={3} accept="image/*">
      <FileUpload.Dropzone>
        ...
        <FileUpload.Description>Drag and drop files here or click to browse</FileUpload.Description>
  ...
  return (
    <FileUpload.Root maxFiles={1} accept=".pdf,.doc,.docx">
      <FileUpload.Dropzone>
        ...
        <FileUpload.Description>PDF or Word document only</FileUpload.Description>
        <FileUpload.Trigger asChild>
...
export default function ValidationExample() {
  ...
  return (
    <FileUpload.Root maxFiles={5} maxFileSize={maxFileSize} accept="image/jpeg,image/png,image/gif">
      <FileUpload.Dropzone>
        <FileUpload.Label>Upload Images</FileUpload.Label>
          ...
          {({ acceptedFiles, rejectedFiles }) => (
            <>
              ...
              {rejectedFiles.map((fileRejection, id) => (
                ...
                >
                  <div style={{ fontWeight: "500", color: "red" }}>{fileRejection.file.name}</div>
...
export default function ControlledExample() {
  ...
  return (
    <div>
      ...
      <FileUpload.Root files={files} onFilesChange={setFiles} maxFiles={3}>
        <FileUpload.Dropzone>
          <FileUpload.Label>Controlled Upload</FileUpload.Label>
          <FileUpload.Description>External state management</FileUpload.Description>
          <FileUpload.Trigger asChild>
